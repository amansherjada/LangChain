# Prompt Blog: https://medium.com/@princekrampah/prompt-templates-in-langchain-248c015be3e0
...
# HumanMessage(content=) we cannot write directly like this in Prompt Template
# messages = [
