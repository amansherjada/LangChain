...
class SimpleSearchTool(BaseTool):
    ...
    args_schema: Type[BaseModel] = SimpleSearchInput # args_schema define the structure and types of arguments that a tool or function expects.
...
response = agent_executor.invoke({"input": "Search for Latest Indian News"})
